...
function emailPedidoEntregado(orden) {
  ...
  const body = `
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:36px;">
      <tr>
        <td align="center">
          <a href="https://wzmallas.com/tienda/seguimiento.html?id=${encodeURIComponent(orden.id)}" style="display:inline-block;background:${c.accent};color:#FFFFFF;font-size:14px;font-weight:600;padding:14px 32px;border-radius:10px;text-decoration:none;">Ver mi pedido</a>
        </td>
      </tr>
    </table>
